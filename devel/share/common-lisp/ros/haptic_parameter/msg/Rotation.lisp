...
(cl:defmethod cl:initialize-instance :after ((m <Rotation>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Rotation)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name haptic_parameter-msg:<Rotation> is deprecated: use haptic_parameter-msg:Rotation instead.")))

(cl:ensure-generic-function 'm00-val :lambda-list '(m))
(cl:defmethod m00-val ((m <Rotation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader haptic_parameter-msg:m00-val is deprecated.  Use haptic_parameter-msg:m00 instead.")
  (m00 m))

(cl:ensure-generic-function 'm01-val :lambda-list '(m))
(cl:defmethod m01-val ((m <Rotation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader haptic_parameter-msg:m01-val is deprecated.  Use haptic_parameter-msg:m01 instead.")
  (m01 m))

(cl:ensure-generic-function 'm02-val :lambda-list '(m))
(cl:defmethod m02-val ((m <Rotation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader haptic_parameter-msg:m02-val is deprecated.  Use haptic_parameter-msg:m02 instead.")
  (m02 m))

(cl:ensure-generic-function 'm10-val :lambda-list '(m))
(cl:defmethod m10-val ((m <Rotation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader haptic_parameter-msg:m10-val is deprecated.  Use haptic_parameter-msg:m10 instead.")
  (m10 m))

(cl:ensure-generic-function 'm11-val :lambda-list '(m))
(cl:defmethod m11-val ((m <Rotation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader haptic_parameter-msg:m11-val is deprecated.  Use haptic_parameter-msg:m11 instead.")
  (m11 m))

(cl:ensure-generic-function 'm12-val :lambda-list '(m))
(cl:defmethod m12-val ((m <Rotation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader haptic_parameter-msg:m12-val is deprecated.  Use haptic_parameter-msg:m12 instead.")
  (m12 m))

(cl:ensure-generic-function 'm20-val :lambda-list '(m))
(cl:defmethod m20-val ((m <Rotation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader haptic_parameter-msg:m20-val is deprecated.  Use haptic_parameter-msg:m20 instead.")
  (m20 m))

(cl:ensure-generic-function 'm21-val :lambda-list '(m))
(cl:defmethod m21-val ((m <Rotation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader haptic_parameter-msg:m21-val is deprecated.  Use haptic_parameter-msg:m21 instead.")
  (m21 m))

(cl:ensure-generic-function 'm22-val :lambda-list '(m))
(cl:defmethod m22-val ((m <Rotation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader haptic_parameter-msg:m22-val is deprecated.  Use haptic_parameter-msg:m22 instead.")
  (m22 m))
