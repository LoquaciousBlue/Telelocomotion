...
(cl:defmethod cl:initialize-instance :after ((m <Button>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Button)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name haptic_parameter-msg:<Button> is deprecated: use haptic_parameter-msg:Button instead.")))

(cl:ensure-generic-function 'A-val :lambda-list '(m))
(cl:defmethod A-val ((m <Button>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader haptic_parameter-msg:A-val is deprecated.  Use haptic_parameter-msg:A instead.")
  (A m))

(cl:ensure-generic-function 'B-val :lambda-list '(m))
(cl:defmethod B-val ((m <Button>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader haptic_parameter-msg:B-val is deprecated.  Use haptic_parameter-msg:B instead.")
  (B m))
