...
(cl:in-package haptic_parameter-msg)
...
(cl:defclass <Data> (roslisp-msg-protocol:ros-message)
  ((point1
   ...
   (rotation1
    :reader rotation1
    :initarg :rotation1
    :type haptic_parameter-msg:Rotation
    :initform (cl:make-instance 'haptic_parameter-msg:Rotation))
   (button1
    :reader button1
    :initarg :button1
    :type haptic_parameter-msg:Button
    :initform (cl:make-instance 'haptic_parameter-msg:Button))
   (point2
    :reader point2
    :initarg :point2
    :type geometry_msgs-msg:Point
...
(cl:defmethod cl:initialize-instance :after ((m <Data>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Data)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name haptic_parameter-msg:<Data> is deprecated: use haptic_parameter-msg:Data instead.")))

(cl:ensure-generic-function 'point1-val :lambda-list '(m))
(cl:defmethod point1-val ((m <Data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader haptic_parameter-msg:point1-val is deprecated.  Use haptic_parameter-msg:point1 instead.")
  (point1 m))

(cl:ensure-generic-function 'rotation1-val :lambda-list '(m))
(cl:defmethod rotation1-val ((m <Data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader haptic_parameter-msg:rotation1-val is deprecated.  Use haptic_parameter-msg:rotation1 instead.")
  (rotation1 m))

(cl:ensure-generic-function 'button1-val :lambda-list '(m))
(cl:defmethod button1-val ((m <Data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader haptic_parameter-msg:button1-val is deprecated.  Use haptic_parameter-msg:button1 instead.")
  (button1 m))

(cl:ensure-generic-function 'point2-val :lambda-list '(m))
(cl:defmethod point2-val ((m <Data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader haptic_parameter-msg:point2-val is deprecated.  Use haptic_parameter-msg:point2 instead.")
  (point2 m))

(cl:ensure-generic-function 'rotation2-val :lambda-list '(m))
(cl:defmethod rotation2-val ((m <Data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader haptic_parameter-msg:rotation2-val is deprecated.  Use haptic_parameter-msg:rotation2 instead.")
  (rotation2 m))

(cl:ensure-generic-function 'button2-val :lambda-list '(m))
(cl:defmethod button2-val ((m <Data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader haptic_parameter-msg:button2-val is deprecated.  Use haptic_parameter-msg:button2 instead.")
  (button2 m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Data>)))
  ...
  (cl:format cl:nil "geometry_msgs/Point point1~%haptic_parameter/Rotation rotation1~%haptic_parameter/Button button1~%geometry_msgs/Point point2~%haptic_parameter/Rotation rotation2~%haptic_parameter/Button button2~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: haptic_parameter/Rotation~%float64 m00~%float64 m01~%float64 m02~%float64 m10~%float64 m11~%float64 m12~%float64 m20~%float64 m21~%float64 m22~%~%================================================================================~%MSG: haptic_parameter/Button~%float64 A~%float64 B~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Data)))
  "Returns full string definition for message of type 'Data"
  (cl:format cl:nil "geometry_msgs/Point point1~%haptic_parameter/Rotation rotation1~%haptic_parameter/Button button1~%geometry_msgs/Point point2~%haptic_parameter/Rotation rotation2~%haptic_parameter/Button button2~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: haptic_parameter/Rotation~%float64 m00~%float64 m01~%float64 m02~%float64 m10~%float64 m11~%float64 m12~%float64 m20~%float64 m21~%float64 m22~%~%================================================================================~%MSG: haptic_parameter/Button~%float64 A~%float64 B~%~%~%"))
